...
package pkg151911513018_minggu6;
...
//    int bykFile;
    ...
    */
    ...
    public void prosesUtama(){
        ...
        System.out.println("Hasil has0 = \n"+has0);
        System.out.println("");
        String has1=hilangTokenAngkaDariDokumen(has0);
        System.out.println("Hasil has1 = \n"+has1);
        System.out.println("");
        String haStop=hilangStopword(has1);
        System.out.println("Hasil haStop = \n"+haStop);
        System.out.println("");
...
//                        }
 ...
 /*
    ...
    public String hilangSingkatanGelar(String dokumen){
        String fileCek=readFile("docq\\singkatan gelar.txt");
...
//    System.out.println();
   ...
   /*
    ...
    public String hilangStopword(String dokumen){
        String fileCek=readFile("docq\\stopword BI sort.txt");
        fileCek=fileCek.replace("\n","").replace("\r"," ");
        ArrayList cekList=pecahDocBersihJadiKata(fileCek);
        dokumen=" ".concat(dokumen);
        String cek;
